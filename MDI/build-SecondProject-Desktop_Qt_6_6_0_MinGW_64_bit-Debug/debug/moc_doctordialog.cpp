...
#include "../../SecondProject/doctordialog.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDoctorDialogENDCLASS_t qt_meta_stringdata_CLASSDoctorDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 13),  // "doctorCreated"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 14),  // "specialization"
        QT_MOC_LITERAL(43, 10),  // "experience"
        QT_MOC_LITERAL(54, 12)   // "createDoctor"
    },
    "DoctorDialog",
    "doctorCreated",
    "",
...
void DoctorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->doctorCreated((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->createDoctor(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DoctorDialog::*)(const QString & , int );
            if (_t _q_method = &DoctorDialog::doctorCreated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DoctorDialog::doctorCreated(const QString & _t1, int _t2)
{
